        ...
        <div class="row">
            <div class="col s12">
                <div class="page-header">
                    <h1>
                        Class Bulk Upload Errors Details
                    </h1>
                ...
                <div class="panel panel-bordered">
                    <div class="panel-header">
                        <div class="col s12 m6 l6">
                            <button type="button" class="waves-effect waves-purple btn z-depth-3 pull-left" onclick="location.href='<?php echo BASE_URL.$this->erpUserTypeArr[$this->userType].'/bulk_upload_controller/download_bulk_upload_error/class';?>'">Download Excelfile for Re-Upload</button>
                        </div>
                        <div class="col s12 m6 l6">
